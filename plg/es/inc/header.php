	...
	<section class="container-fluid contact-logo">
		<div class="container" style="padding-top: 5px; padding-bottom: 5px;">
			<div class="row" style="padding-top: 10px;">
				...
				<span class="lang-sect"><a href="../"><img class="lang-ico" src="img/en.ico" alt="English"></a><div class="space"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i></div> <a href=""><img class="lang-ico" src="img/es.ico" alt=""></a></span>
				</div></div>
